...
def build_persona_prompt(fact_sheet_path: str) -> str:
    ...
    sections = [
        ...
        "   ",
        "   FOR INFORMATION NOT IN YOUR FACT SHEET (courses, professors, buildings you are not sure about):",
        "   - Do NOT invent specific names or numbers that you cannot verify.",
        "   - Instead, say something like: 'I took a production management course but I cannot recall the exact course code.'",
        "   - This prevents you from stating wrong facts that get contradicted later.",
        "   - If you already stated a specific fact, do NOT retract it — stick with it.",
        "   ",
